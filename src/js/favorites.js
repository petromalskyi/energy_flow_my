     ...
     <li class="second-item">
          <div class="second-position-one">
            <div class="second-flex">
              ...
              <div class="second-flex-one">
                <button type="button" class="js-favorite-btn" data-action='delete' data-id=${arrKeysStorage[i]}>
                    ...
                    <use href="../img/symbol-defs.svg#icon-trash" data-action='delete' data-id=${arrKeysStorage[i]}></use>
                    </svg>
                </button>
              </div>
            </div>
            <button type="button" class="js-second-btn" data-id=${arrKeysStorage[i]}>
              Start
 <svg class="second-arrow-icon" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
